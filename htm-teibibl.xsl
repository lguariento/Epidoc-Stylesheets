...
<xsl:stylesheet xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:html="http://www.w3.org/1999/html" xmlns:f="http://example.com/ns/functions" xmlns:t="http://www.tei-c.org/ns/1.0" exclude-result-prefixes="t f" version="2.0">
				...
				<xsl:choose>
					...
					<xsl:when test=".[t:ptr]">
						...
						<xsl:choose>
							...
							<xsl:when test="$parm-edn-structure='ogham' and ancestor::t:div[@type = 'bibliography']">
